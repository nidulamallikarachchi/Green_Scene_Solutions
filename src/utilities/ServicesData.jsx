...
export const services = [
    {
        ...
        description:
            "Our team has extensive experience maintaining strata-managed properties across Melbourne. We understand the unique needs of both residents and managers, ensuring that communal spaces are always clean, welcoming, and compliant with regulations. \n\n Because every building is different, we tailor our services to match your property’s exact requirements. From routine cleaning and gardening to responding quickly to any building-related concerns, we’ll make sure your space always looks its best. \n\n Let us handle the day-to-day upkeep, so your residents can feel proud to call it home.",
    ...
    },
    {
        ...
        description:
            "We understand that your office’s appearance speaks volumes about your business. That’s why our commercial cleaning team uses a thorough checklist system to ensure every space is pristine. \n\n From polishing high-touch surfaces to maintaining pristine floors and carpets, we create a welcoming environment for employees and clients alike. Our safe, non-toxic products keep the workplace hygienic without compromising on health. \n\n With flexible scheduling and custom plans, we work around your hours to minimize disruptions and let you focus on running your business.",
    ...
    },
    {
        ...
        description: "Our skilled gardeners have been helping Melbourne residents for over a decade. From lawn mowing and weeding to total landscaping transformations, we have the expertise to bring your vision to life. \n\n We offer advice on plant selection, irrigation, and garden layouts that match both your taste and the local environment. Whether you’re after a low-maintenance garden or a lush green retreat, we’ll create an outdoor space you’ll love. \n\n Relax and enjoy the beauty of a well-kept garden—without spending hours doing the hard work yourself.",
    ...
    },
    {
        ...
        description: "Our experienced carpet technicians know exactly how to banish dirt and odors from deep within carpet fibers. We use powerful steam cleaning equipment that leaves your carpets fresher, softer, and safer underfoot.\n\n By targeting embedded grime and bacteria, we extend the life of your carpets while also improving indoor air quality. Whether you’re dealing with heavy foot traffic or just routine wear, we’ll make sure your carpets look like new. \n\nLet us take care of the stains and odors so you can enjoy the warmth and comfort that quality carpets bring to any space.",
    ...
    },
    {
        ...
        description: "Nothing brightens a space like clean windows. We remove smudges, streaks, and watermarks so you can let the natural light shine through. \n\n From high-rise exteriors to modest home windows, our trained professionals follow strict safety procedures and use the best tools to get a sparkling finish.\n\n Transform your view, enhance curb appeal, and make your property look its best—one window at a time.",
    ...
    },
    {
        ...
        description: "Our high-pressure washing service strips away dirt, mold, and grease from almost any hard surface, instantly revitalizing the look of your property. \n\n From driveways to facades, we use specialized equipment to get top-notch results quickly. By using eco-friendly methods and focusing on safety, we protect both your surfaces and the environment. Let us handle the heavy buildup so you can enjoy cleaner, brighter outdoor spaces. \n\n See the difference a thorough wash can make—transform dull, grimy areas into clean, welcoming spaces.",
    ...
    },
    {
        ...
        description: "Car parks gather a lot of dirt, grease, and debris over time. Our specialized cleaning system tackles stains, grime, and contamination to restore a professional look to your car park. \n\n Using powerful scrubbers, sweepers, and extraction methods, we remove both surface-level debris and deeply embedded residues. From oil spots to general buildup, we’ve got it covered. \n\n Whether you manage a large multi-level garage or a small private lot, let us keep your parking space inviting, safe, and spotless.",
    ...
    },
    {
        ...
        description: "Moving into a new building can be chaotic for everyone. Our move-in services aim to minimize disruptions by scheduling move-ins, guiding revivalists, and protecting common areas. We ensure lifts aren’t damaged, hallways aren’t blocked, and other residents aren’t inconvenienced. \n\n We also handle excess packaging and rubbish, keeping communal areas neat. Once you’re settled, we offer building orientations and essential info to help new occupants feel at home right away.",
    ...
    },
    {
        ...
        description: "Our end of lease cleaning focuses on every corner—kitchens, bathrooms, floors, and hidden spots most people forget. We help you leave the property in top condition for your final inspection, giving you the best chance at getting your bond back. \n\n We understand the stress of moving, so we handle the cleaning details while you focus on settling into your new place. With thorough sanitization and careful attention to small marks and stains, we’ll have the property looking like it did on day one. \n\n Relax and let us do the heavy lifting. We’ll have your old place looking spotless in no time.",
    ...
    },
    {
        ...
        description: "Industrial spaces require rigorous, specialized cleaning strategies. Our team is trained to handle heavy machinery, warehouses, and large-scale facilities while adhering to strict safety standards. \n\n We remove built-up dust, grease, and debris to create a safer workplace that minimizes hazards and maximizes efficiency. From scheduled cleanings to urgent spill response, we’ve got your operations covered. \n\n Keep your industrial environment organized, clean, and ready for business with our all-inclusive service packages.",
    ...
    },
    {
        ...
        description: "After the builders finish, the site is often covered in dust, debris, and leftover materials. We specialize in post-construction cleaning to make sure your space is ready for inspection or occupation. \n\n From removing plaster dust to high-pressure washing exterior surfaces, we apply proven methods and the right equipment to get the job done thoroughly. Safety and compliance are always top priorities. \n\n Let us handle the final cleanup so you can focus on what comes next—be it showing the property, staging, or moving in.",
    ...
    },
    {
        ...
        description:
            "We are proud to partner with reputable providers, including Accent Home Care, to offer a comprehensive range of in-home support. Our main focus is on providing top-notch Gardening & Landscaping services—ensuring every outdoor space remains vibrant and well-kept. \n\n In addition, we assist with essential Home Maintenance tasks, giving you peace of mind that your home is always safe and comfortable. Our dedicated team works around your schedule, offering a personalized approach to keep your home looking its best inside and out.",
        subDescription:
